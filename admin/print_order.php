...
<body>
    ...
    $result_invoice = mysqli_query($cx, $sql_purchase);
...
?>
    <div class="container">
        ...
        <?php
            ...
            echo "<p>วันครบกำหนดชำระเงิน <span style='color: red;'>$newDate</span></p>";
        ?>


        <p>สถานะใบแจ้งหนี้ <?php echo $status; ?></p>
        

    </div>

    <div class="button_con">
        <a href="invoicepdf.php?purchaseNo=<?php echo $purchaseNo; ?>&custno=<?php echo $custNo; ?>">
            <button>พิมพ์ใบแจ้งหนี้</button>
        </a>
        ...
        <form action="updateStatus.php" method="post">
            ...
            <button type="submit">จ่ายแล้ว</button>
        </form>
