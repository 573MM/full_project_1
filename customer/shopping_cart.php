        ...
        <table>
            ...
            <?php
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        //echo "<input type='hidden' class='quantity-input' name='qty[]' value='{$row['ProductQty']}'> ";

                        //echo "<td><input type='text' name='qty[]' value='1' maxlength='6'></td>";
                        echo "<td><div class='product_qty'>
                        <button class='quantity-btn minus-btn'>-</button>
                        <input type='text' class='quantity-input' name='qty[]' value='{$row['ProductQty']}'>
                        <button class='quantity-btn plus-btn'>+</button></div></td>";


                        // echo "<td><div class='product_qty'>
                        // <button class='quantity-btn minus-btn'>-</button>
                        // <input type='text' class='quantity-hidden' name='qty[]' value='{$row['ProductQty']}'>
                        // <button class='quantity-btn plus-btn'>+</button></div></td>";
