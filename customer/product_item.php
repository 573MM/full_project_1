...
<body>
    ...
    <div class=container_product>
        ...
        <div class="inform">
            ...
            <button class="buy_now" onclick="buyNow('<?php echo $productNo; ?>')">ซื้อสินค้า</button>
    ...
    <script>
        function buyNow(productNo) {
            ...
            // window.location.href = 'test_make.php?productNo=' + productNo.'&custno='.custId.'&qty='.;
            ...
            // เพิ่มพารามิเตอร์ custId, productNo, และ qty ใน URL แล้ว redirect ไปยัง test_make.php
            window.location.href = 'test_make.php?productNo[]=' + productNo + '&custno=' + custId + '&qty[]=' + qty;
        }
